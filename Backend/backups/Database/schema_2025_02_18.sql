...
CREATE TABLE IF NOT EXISTS "library"."sms_schedule" (
    "id" "text" NOT NULL,
    "message" "text" NOT NULL
);


ALTER TABLE "library"."sms_schedule" OWNER TO "postgres";
...
ALTER TABLE ONLY "library"."sms_schedule"
    ADD CONSTRAINT "sms_schedule_pkey" PRIMARY KEY ("id");
...
CREATE POLICY "Disable all access" ON "library"."sms_schedule" USING (false);
...
GRANT ALL ON TABLE "library"."sms_schedule" TO "service_role";
GRANT ALL ON TABLE "library"."sms_schedule" TO "authenticated";
