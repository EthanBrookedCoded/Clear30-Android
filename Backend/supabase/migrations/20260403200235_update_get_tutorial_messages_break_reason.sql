-- New function: get_tutorial_messages_v2 with optional break_reason parameter
-- When provided, filters messages by that specific break reason
-- When null, uses existing assessment-based filtering
-- Original get_tutorial_messages is left untouched for old clients
...
BEGIN
    ...
    WITH base_message_data AS (
        ...
        AND (
            ...
            OR (
                _break_reason IS NULL
                AND pm.question_id IS NOT NULL
                AND (
                    (
