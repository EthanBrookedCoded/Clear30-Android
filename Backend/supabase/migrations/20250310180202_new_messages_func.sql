alter table "programs"."programs" add column "start_soon" text;

alter table "programs"."programs" add constraint "programs_start_soon_fkey" FOREIGN KEY (start_soon) REFERENCES programs.programs(id) ON UPDATE CASCADE not valid;

alter table "programs"."programs" validate constraint "programs_start_soon_fkey";
