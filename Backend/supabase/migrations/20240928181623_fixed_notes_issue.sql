CREATE UNIQUE INDEX group_notes_unique_constraint ON public.group_notes USING btree (group_id, from_member_id, to_member_id, "timestamp");

alter table "public"."group_notes" add constraint "group_notes_unique_constraint" UNIQUE using index "group_notes_unique_constraint";
