-- Add AppStack fields to users table
ALTER TABLE "public"."users" ADD COLUMN IF NOT EXISTS "appstack_id" text;
ALTER TABLE "public"."users" ADD COLUMN IF NOT EXISTS "appstack_attribution" jsonb;

-- Update create_user function to handle new AppStack fields
