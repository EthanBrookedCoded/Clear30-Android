-- Update get_tutorial_messages to return both claire_prompts and claire_prompts_json
-- This matches the changes made to program_get_messages in 20260122185143_claire_prompts_extended_fields.sql
