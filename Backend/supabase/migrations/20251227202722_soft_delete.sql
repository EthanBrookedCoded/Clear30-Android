...
-- This migration modifies delete_user() to only delete from public.users
-- while preserving auth.users, allowing users to log back in and maintain their user_id

-- Step 1: Modify delete_user() function to only delete from public.users
