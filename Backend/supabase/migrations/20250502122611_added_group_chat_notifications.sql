...
CREATE TRIGGER schedule_group_message_notification AFTER INSERT ON groups.group_messages FOR EACH ROW EXECUTE FUNCTION comms.add_group_message_notification();
