-- This migration updates the get_filtered_posts RPC to:
-- 1. Add option to exclude pinned posts
-- 2. Add minimum comment threshold filter
-- 3. Add sorting by views/engagement
...
BEGIN
    ...
    -- Get total count first with comment count filtering
