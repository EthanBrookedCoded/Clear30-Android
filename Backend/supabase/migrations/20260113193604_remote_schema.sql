...
revoke delete on table "auth"."oauth_authorizations" from "dashboard_user";

revoke insert on table "auth"."oauth_authorizations" from "dashboard_user";

revoke references on table "auth"."oauth_authorizations" from "dashboard_user";

revoke select on table "auth"."oauth_authorizations" from "dashboard_user";

revoke trigger on table "auth"."oauth_authorizations" from "dashboard_user";

revoke truncate on table "auth"."oauth_authorizations" from "dashboard_user";

revoke update on table "auth"."oauth_authorizations" from "dashboard_user";

revoke delete on table "auth"."oauth_client_states" from "dashboard_user";

revoke insert on table "auth"."oauth_client_states" from "dashboard_user";

revoke references on table "auth"."oauth_client_states" from "dashboard_user";

revoke select on table "auth"."oauth_client_states" from "dashboard_user";

revoke trigger on table "auth"."oauth_client_states" from "dashboard_user";

revoke truncate on table "auth"."oauth_client_states" from "dashboard_user";

revoke update on table "auth"."oauth_client_states" from "dashboard_user";

revoke delete on table "auth"."oauth_clients" from "dashboard_user";

revoke insert on table "auth"."oauth_clients" from "dashboard_user";

revoke references on table "auth"."oauth_clients" from "dashboard_user";

revoke select on table "auth"."oauth_clients" from "dashboard_user";

revoke trigger on table "auth"."oauth_clients" from "dashboard_user";

revoke truncate on table "auth"."oauth_clients" from "dashboard_user";

revoke update on table "auth"."oauth_clients" from "dashboard_user";

revoke delete on table "auth"."oauth_consents" from "dashboard_user";

revoke insert on table "auth"."oauth_consents" from "dashboard_user";

revoke references on table "auth"."oauth_consents" from "dashboard_user";

revoke select on table "auth"."oauth_consents" from "dashboard_user";

revoke trigger on table "auth"."oauth_consents" from "dashboard_user";

revoke truncate on table "auth"."oauth_consents" from "dashboard_user";

revoke update on table "auth"."oauth_consents" from "dashboard_user";
