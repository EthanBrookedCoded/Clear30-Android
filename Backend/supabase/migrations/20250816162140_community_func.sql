-- Add RPC function to get community posts by titles
-- This function safely handles special characters in titles that would break regular queries

CREATE OR REPLACE FUNCTION get_posts_by_titles(
    titles text[],
    min_comments integer DEFAULT 1,
